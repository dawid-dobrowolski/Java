...
public class DataFrameTest {
    ...
    public void testIlocSet() {
        ...
        assertEquals(12, col1.getData().get(0));
        assertEquals(false, col2.getData().get(1));
        assertEquals(34.4f, col3.getData().get(2));
        assertEquals("forty five", col4.getData().get(3));

        df.ilocSet(0, "col1", "92");
        df.ilocSet(1, "col2", "true");
        df.ilocSet(2, "col3", "99.4");
        df.ilocSet(3, "col4", null);
   ...
   /* @Test(expected = NumberFormatException.class)
    ...
    public void testAddColumnInplace() {
        ...
        assertEquals("0", new1.getData().get(0));
        assertEquals(0, new2.getData().get(1));
        assertEquals(0.0f, new3.getData().get(2));
        assertEquals((short) 0, new4.getData().get(3));
        assertEquals(false, new5.getData().get(4));
